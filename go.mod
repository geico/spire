...
require (
	...
	github.com/tjons/cassandra-toolbox v0.1.1
...
replace github.com/spiffe/spire-plugin-sdk => github.com/geico/spire-plugin-sdk v0.0.0-20260831155804-6755c44f702b
